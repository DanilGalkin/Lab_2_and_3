...
2. Использованы компоненты Bootstrap: Nav, Cards, Modal, Popover, Toasts
	...
	Cards - карточки которые ты видишь на страничке.Картинка + текст 
		
	Modal - модальные окна с дополинтельной информацией 
...
объекту, из которого вызван.
	...
	При нажатии на карточку с информацией,запускается скрипт 
